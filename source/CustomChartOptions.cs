...
internal static class CustomChartOptions
{
    ...
    internal static readonly OptionsMenuIntegration.RowSpec[] Rows =
    {
        ...
        new("StateToggle_FlatChartBattleCreator",
            "Battle creator",
            "Make or edit custom battles for the arcade: song, charts, enemy and gear.",
            new[] { "Open..." },
            () => 0,
            (direction, click) => { if (click && ActionAllowed("StateToggle_FlatChartBattleCreator")) BattleCreator.Open(); }),
