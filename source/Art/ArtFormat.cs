...
internal static class EnemyArtReader
{
    ...
    internal static EnemyArtSpec? Read(JsonElement art, PackageFiles files, string lookName, List<string> problems, List<string> stamps, out string? unusable)
    {
        ...
        foreach (var name in Names)
        {
            ...
            try
            {
                var a = ReadAnimation(name, node, files, notes, stamps);
    ...
    private static ArtAnimationSpec ReadAnimation(string name, JsonElement node, PackageFiles files, List<string> notes, List<string> stamps)
    {
