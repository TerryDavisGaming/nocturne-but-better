...
presses on a real keyboard or controller haven't been tried, and the skins haven't been tried on a five-lane chart. only the firefly battle was played, so the vines, other enemies' attack effects, mines, and critical misses at high volume weren't seen or heard in a fight.
